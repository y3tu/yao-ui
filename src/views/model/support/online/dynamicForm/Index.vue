<template>
    <div class="app-container">
        ...
        <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
            ...
            <el-table-column prop="jsonTemplate" label="表单json字符串模板" />
            <el-table-column prop="status" label="0正常 1禁用" />
            ...
            <el-table-column v-has-permission="['dynamicForm:update','dynamicForm:delete']" label="操作" width="150px" align="center">
                <template slot-scope="scope">
                    <udOperation
                            :data="scope.row"
...
<script>
    ...
    export default {
        ...
        cruds() {
            return CRUD({ title: 'DynamicForm', url: 'support/online/dynamicForm/page', idField: 'id' , sort: 'id,desc', crudMethod: { ...crudDynamicForm }})
        },
        data() {
            return {
                permission: {
