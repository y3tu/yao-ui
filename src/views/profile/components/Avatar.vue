<template>
    <el-dialog
        ...
        <el-tabs v-model="activeName" class="avatar-tabs">
            ...
            <el-tab-pane label="自定义上传" name="fourth">
                <el-upload
    ...
    export default {
        ...
        methods: {
            ...
            handleAvatarSuccess(res, file) {
                ...
                this.$put('base/user/avatar', {avatar: res.data}).then(() => {
            ...
            beforeAvatarUpload(file) {
                const isPicture = file.type === 'image/jpeg'||file.type==='image/gif' ||file.type==='image/png';
