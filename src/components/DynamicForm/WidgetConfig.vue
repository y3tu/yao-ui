    ...
    <div v-if="show">
        <el-form label-position="top">
            ...
            <el-form-item label="大小" v-if="Object.keys(data.options).indexOf('size')>=0">
                宽度
                <el-input style="width: 90px;" type="number" v-model.number="data.options.size.width"/>
                高度
                <el-input style="width: 90px;" type="number" v-model.number="data.options.size.height"/>
            </el-form-item>
            ...
            <el-form-item label="是否多选" v-if="data.type==='select' || data.type==='imgupload'">
                <el-switch v-model="data.options.multiple" @change="handleSelectMultiple"/>
            </el-form-item>
                            ...
                            <draggable tag="ul" :list="data.options.options"
                                ...
                                <li v-for="(item, index) in data.options.options" :key="index">
                                    <el-radio
                                        ...
                                        <el-input :style="{'width': data.options.showLabel? '90px': '180px' }" size="mini" v-model="item.value"/>
            ...
            <el-form-item label="默认值"
                ...
                <el-rate v-if="data.type === 'rate'" style="display:inline-block;vertical-align: middle;" :max="data.options.max"
                         :allow-half="data.options.allowHalf" v-model="data.options.defaultValue"/>
                <el-button type="text" v-if="data.type === 'rate'" style="display:inline-block;vertical-align: middle;margin-left: 10px;"
